#!/usr/bin/env python3
"""
Pre-generate 2026 actual weather profiles for all ERCOT hubs.
This ensures the cache is populated with actual 2026 data before running the app.
"""
...
print("=" * 70)
print("Pre-generating 2026 Actual Weather Profiles for All Hubs")
print("=" * 70)
...
for hub_name, (lat, lon) in HUB_LOCATIONS.items():
    ...
    print(f"  Generating 2026 Solar profile...")
    ...
    print(f"  Generating 2026 Wind profile...")
...
print("\n" + "=" * 70)
print("✅ All 2026 actual weather profiles pre-generated!")
print("=" * 70)
