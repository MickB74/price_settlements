#!/usr/bin/env python3
"""
Update ercot_rtm_2025.parquet with all days in 2025.

This script:
1. Loads the existing parquet file
2. Fetches the complete 2025 data from ERCOT via gridstatus
3. Saves the updated file with all days in 2025
"""
...
def update_ercot_2025():
    """Fetch and save complete 2025 ERCOT RTM data."""
    
    cache_file = "ercot_rtm_2025.parquet"
    
    print("=" * 60)
    print("ERCOT RTM 2025 Data Update Script")
    print("=" * 60)
    ...
    # Fetch complete 2025 data
    print("\n" + "-" * 60)
    print("Fetching complete 2025 data from ERCOT...")
    ...
    try:
        ...
        print(f"\n✓ Successfully fetched 2025 data")
